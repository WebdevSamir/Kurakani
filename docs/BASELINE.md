...
BEIR is a heterogeneous information-retrieval benchmark containing datasets across multiple tasks and domains, and its authors report BM25 as a robust baseline. citeturn1academia1

For multi-hop research, HotpotQA is useful because it contains questions requiring evidence from multiple documents and provides supporting facts. citeturn1academia0

For multilingual research, MIRACL provides relevance judgments across 18 languages and can become relevant if Kurakani is extended toward multilingual retrieval. citeturn1academia2

We should not mix these datasets casually: each experiment needs a defined task, corpus, query set, and metric.

## Evaluation direction

The current RAG evaluation literature emphasizes separate measurement of retrieval and generation rather than relying on one end-to-end score. citeturn0academia0turn0search4
